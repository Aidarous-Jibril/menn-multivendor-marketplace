...
import { deleteOrder, fetchOrders, fetchSingleOrder, updateOrder, updateOrderStatus} from "@/redux/slices/adminSlice";
...
const AllOrdersTable = () => {
  ...
  // Filter orders whenever searchQuery or orders change
  useEffect(() => {
    setFilteredOrders(
      orders.filter(
        (order) =>
